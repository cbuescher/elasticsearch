...
public abstract class BooleanFieldScript extends AbstractFieldScript {
    ...
    public static final Factory PARSE_FROM_SOURCE = new Factory() {
        ...
        public LeafFactory newFactory(String field, Map<String, Object> params, SearchLookup lookup, boolean onErrorContinue) {
            return ctx -> new BooleanFieldScript(field, params, lookup, ctx, false) {
                @Override
                public void execute() {
                    emitFromSource();
                }
    ...
    public static Factory leafAdapter(Function<SearchLookup, CompositeFieldScript.LeafFactory> parentFactory) {
        return (leafFieldName, params, searchLookup, onErrroContinue) -> {
            ...
            return (LeafFactory) ctx -> {
                ...
                return new BooleanFieldScript(leafFieldName, params, searchLookup, ctx, false) {
                    @Override
