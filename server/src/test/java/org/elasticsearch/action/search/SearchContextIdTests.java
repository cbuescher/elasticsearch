...
public class SearchContextIdTests extends ESTestCase {
    ...
    public void testDecodingPITS() {
        ...
        SearchContextId originalId = SearchContextId.decode(
            new NamedWriteableRegistry(Collections.emptyList()),
            new BytesArray(Base64.getUrlDecoder().decode(original))
        );
        SearchContextId updatedId = SearchContextId.decode(
            new NamedWriteableRegistry(Collections.emptyList()),
            new BytesArray(Base64.getUrlDecoder().decode(updated))
        );
