...
public abstract class FilterClient extends AbstractClient {
    ...
    @Override
    protected <Request extends ActionRequest, Response extends TransportResponse, RequestBuilder extends ActionRequestBuilder<Request, Response, RequestBuilder>> void doExecute(
