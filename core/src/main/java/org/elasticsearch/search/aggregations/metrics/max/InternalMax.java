...
public class InternalMax extends InternalNumericMetricsAggregation.SingleValue implements Max {
    ...
    public static InternalMax parseXContentBody(String name, XContentParser parser) {
        ...
        double max = (Double) map.getOrDefault(CommonFields.VALUE.getPreferredName(),
        ...
        if (valueAsString != null) {
            formatter = InternalNumericMetricsAggregation.wrapValueAsString(Collections.singletonMap(max, valueAsString));
        }
