...
| SSH alias            | public DNS name                                             | role                               | private IP (10 Gbit) |
|----------------------|-------------------------------------------------------------|------------------------------------|----------------------|
| ``long-run-rally-1`` | ``longrun-669376.benchmark.fsn1-dc4.hetzner.elasticnet.co`` | benchmark coordinator, load driver | 192.168.14.76        |
| ``long-run-rally-2`` | ``longrun-669377.benchmark.fsn1-dc4.hetzner.elasticnet.co`` | benchmark target node              | 192.168.14.77        |
| ``long-run-rally-3`` | ``longrun-669378.benchmark.fsn1-dc4.hetzner.elasticnet.co`` | benchmark target node              | 192.168.14.78        |
| ``long-run-rally-4`` | ``longrun-669380.benchmark.fsn1-dc4.hetzner.elasticnet.co`` | benchmark target node              | 192.168.14.80        |
