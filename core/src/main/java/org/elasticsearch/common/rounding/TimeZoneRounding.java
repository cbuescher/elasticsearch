    ...
    static class TimeUnitRounding extends TimeZoneRounding {
        ...
        public long roundKey(long utcMillis) {
            ...
            if (timeZone.isFixed() == false && timeZone.getOffset(utcMillis) != timeZone.getOffset(rounded)) {
                // we crossed a time zone transition, in some edge cases this will
                // result in a value that is not a proper rounded key itself. Here
                // we round again to make sure rounding is always idempotent
        ...
        public long nextRoundingValue(long utcMillis) {
            ...
            if (next == floor) {
                // in this rare case we need to add more than one unit
