...
public class MyGraphTokenStreamFiniteStringsTests extends LuceneTestCase{
    ...
    private static Token token(String term, int posInc, int posLength) {
      ...
      public void testIllegalState() throws Exception {
        expectThrows(IllegalStateException.class, () -> {
          ...
          new MyGraphTokenStreamFiniteStrings(ts).getFiniteStrings();
        });
      }
      ...
      public void testEmpty() throws Exception {
        ...
        MyGraphTokenStreamFiniteStrings graph = new MyGraphTokenStreamFiniteStrings(ts);
      ...
      public void testSidePathWithGap() throws Exception {
        ...
        MyGraphTokenStreamFiniteStrings graph = new MyGraphTokenStreamFiniteStrings(cts);
        Iterator<TokenStream> it = graph.getFiniteStrings();
        assertTrue(it.hasNext());
